...
class Profile(models.Model):
    ...
    #symmetrical means, in this case, that you can follow a person, but this person doesn't have to follow you back
    date_modified = models.DateTimeField(User, auto_now=True)
    profile_image = models.ImageField(null=True, blank=True, upload_to='images/')
    profile_bio = models.CharField(null=True, blank=True, max_length=600)
